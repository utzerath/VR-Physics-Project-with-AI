...
namespace Filo{
    ...
    public class CableDisc : CableBody
    {
        ...
        public override void AppendSamples(CableRenderer.SampledCable samples, Vector3 origin, float spacing, float distance, float spoolSeparation, bool reverse, bool orientation){
            ...
            if (ScaledRadius < 1e-4 || distance < 1e-4 || sp < 1e-4)
            {
